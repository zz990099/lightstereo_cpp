...
TEST(lightstereo_test, trt_core_correctness)
{
...
TEST(lightstereo_test, trt_core_speed)
{
  auto model         = CreateLightStereoModel();
  auto [left, right] = ReadTestImages();
...
TEST(lightstereo_test, trt_core_pipeline_correctness)
{
  auto model         = CreateLightStereoModel();
  model->InitPipeline();
  auto [left, right] = ReadTestImages();
...
TEST(lightstereo_test, trt_core_pipeline_speed)
{
  auto model         = CreateLightStereoModel();
  model->InitPipeline();
  auto [left, right] = ReadTestImages();
